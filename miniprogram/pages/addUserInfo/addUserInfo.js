...
Page({
  ...
  onLoad: function (options) {
    ...
    try {
      wx.removeStorageSync('qrImgPath')
      wx.removeStorageSync('idImgPath')
      wx.removeStorageSync('profileImgPath')
    } catch (e) {
  ...
  saveStudentInfo: function () {
    ...
    var qrImgPath = wx.getStorageSync('qrImgPath')
    var idImgPath = wx.getStorageSync('idImgPath')
    var profileImgPath = wx.getStorageSync('profileImgPath')
    console.log("path", qrImgPath, idImgPath, profileImgPath)
    if (!qrImgPath || !idImgPath || !profileImgPath) {
      wx.showToast({
        title: '请提供完整信息！',
      })
      return
